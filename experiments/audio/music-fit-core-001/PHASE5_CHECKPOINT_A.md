...
`tests/legacy_phase34_golden.json` freezes eight ordered edit-map digests generated with the unmodified v0.1.1 core, not with the new implementation. Its baseline blob is `9a73c5bc1c29196df594e20b8b25fd8d6ab41c95`. The digest covers candidate order/ID, target frames, source spans, ending mode and strategy; it deliberately excludes floating transition diagnostics/costs because Windows/Linux BLAS can differ by tiny floating-point amounts without changing the selected edit map. The golden source came from the verified Windows artifact `10558097162`, run `35370982684`, ZIP SHA256 `cfbc17c9d5682edc85f83d7c58387ada5e0b02bc0f52e76dba6e0d566977134b`. Core/fixture source blobs were matched to the base commit after CRLF normalization.
