...
try{
 ...
 'undo_manager_surface','undo_insert','undo_split_created','undo_available_after_split','undo_restores_one_piece','redo_available_after_undo','redo_restores_two_pieces'
 )
